...
public class VPSGetCardStepDef {
    ...
    public VPSGetCardStepDef(TestContext testContext){
    ...
    @Given("^User sets the baseURI and basePath for GETCard request$")
    public void userSetsTheBaseURIAndBasePathForGETCardRequest() throws Exception{
    ...
    public void userSendsTheAPIRequestToGETCardRequest() throws Exception {
    ...
    public void storeThePaymentReferenceNumberAndDisplayOnConsoleForGetCardRequest() {
        ...
        System.out.println("paymentReferenceNumber for GETCard Request :- " + paymentReferenceNumber);
    }
}
