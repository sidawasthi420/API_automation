...
public class VPSUpdateModifyStepDef {
    ...
    public VPSUpdateModifyStepDef(TestContext testContext){
    ...
    @Given("^User sets the baseURI and basePath for Update Modify request$")
    public void userSetsTheBaseURIAndBasePathForUpdateModifyRequest() throws Exception{
    ...
    public void userSendsTheAPIRequestToUpdateModifyRequest() throws Exception {
    ...
    public void storeThePaymentReferenceNumberAndDisplayOnConsoleForUpdateModifyRequest() {
        ...
        System.out.println("paymentReferenceNumber for Update Modify Request :- " + paymentReferenceNumber);
    }
}
