...
public class VPSUpdateModifyTestStepDef {
    ...
    public VPSUpdateModifyTestStepDef(TestContext testContext){
    ...
    @Given("^User sets the baseURI and basePath for Update Modify Test request$")
    public void userSetsTheBaseURIAndBasePathForUpdateModifyTestRequest() throws Exception{
    ...
    public void userSendsTheAPIRequestToUpdateModifyTestRequest() throws Exception {
    ...
    public void storeThePaymentReferenceNumberAndDisplayOnConsoleForUpdateModifyTestRequest() {
        ...
        System.out.println("paymentReferenceNumber for Update Modify Test Request :- " + paymentReferenceNumber);
    }
}
