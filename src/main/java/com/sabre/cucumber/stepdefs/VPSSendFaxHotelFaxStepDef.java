...
public class VPSSendFaxHotelFaxStepDef {
    ...
    public VPSSendFaxHotelFaxStepDef(TestContext testContext){
    ...
    @Given("^User sets the baseURI and basePath for SendFaxHotelFax request$")
    public void userSetsTheBaseURIAndBasePathForSendFaxHotelFaxRequest() throws Exception{
    ...
    public void userSendsTheAPIRequestToSendFaxHotelFaxRequest() throws Exception {
    ...
    public void storeThePaymentReferenceNumberAndDisplayOnConsoleForSendFaxHotelFaxRequest() {
        ...
        System.out.println("paymentReferenceNumber for SendFaxHotelFax Request :- " + paymentReferenceNumber);
    }
}
