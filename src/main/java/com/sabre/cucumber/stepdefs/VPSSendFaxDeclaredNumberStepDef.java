...
public class VPSSendFaxDeclaredNumberStepDef {
    ...
    public VPSSendFaxDeclaredNumberStepDef(TestContext testContext){
    ...
    @Given("^User sets the baseURI and basePath for SendFaxDeclaredNumber request$")
    public void userSetsTheBaseURIAndBasePathForSendFaxDeclaredNumberRequest() throws Exception{
    ...
    public void userSendsTheAPIRequestToSendFaxDeclaredNumberRequest() throws Exception {
    ...
    public void storeThePaymentReferenceNumberAndDisplayOnConsoleForSendFaxDeclaredNumberRequest() {
        ...
        System.out.println("paymentReferenceNumber for SendFaxDeclaredNumber Request :- " + paymentReferenceNumber);
    }
}