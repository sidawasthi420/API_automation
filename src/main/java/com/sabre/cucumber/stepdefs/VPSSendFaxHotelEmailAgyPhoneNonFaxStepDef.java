...
public class VPSSendFaxHotelEmailAgyPhoneNonFaxStepDef {
    ...
    public VPSSendFaxHotelEmailAgyPhoneNonFaxStepDef(TestContext testContext){
    ...
    @Given("^User sets the baseURI and basePath for SendFaxHotelEmailAgyPhoneNonFax request$")
    public void userSetsTheBaseURIAndBasePathForSendFaxHotelEmailAgyPhoneNonFaxRequest() throws Exception{
    ...
    public void userSendsTheAPIRequestToSendFaxHotelEmailAgyPhoneNonFaxRequest() throws Exception {
    ...
    public void storeThePaymentReferenceNumberAndDisplayOnConsoleForSendFaxHotelEmailAgyPhoneNonFaxRequest() {
        ...
        System.out.println("paymentReferenceNumber for SendFaxHotelEmailAgyPhoneNonFax Request :- " + paymentReferenceNumber);
    }
}