...
public class VPSGetSendFaxHistoryStepDef {
    private CommonLib commonLib;
    private vpsMain vps_main;
    private static String recordLocatorNewValue;
    private Response response;
    private static String bodyParameter;
    private static String paymentReferenceNumber;
    private AssertionService assertionService;

    public VPSGetSendFaxHistoryStepDef(TestContext testContext){
    ...
    @Given("^User sets the baseURI and basePath for GETSendFaxHistory request$")
    public void userSetsTheBaseURIAndBasePathForGETSendFaxHistoryRequest() throws Exception{
    ...
    public void userSendsTheAPIRequestToGETSendFaxHistoryRequest() throws Exception {
    ...
    public void storeThePaymentReferenceNumberAndDisplayOnConsoleForGETSendFaxHistoryRequest() {
        ...
        System.out.println("paymentReferenceNumber for GETSendFaxHistory Request :- " + paymentReferenceNumber);
    }
}
