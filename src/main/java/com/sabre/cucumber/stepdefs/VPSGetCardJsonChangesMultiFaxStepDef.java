...
public class VPSGetCardJsonChangesMultiFaxStepDef {
    ...
    public VPSGetCardJsonChangesMultiFaxStepDef(TestContext testContext){
    ...
    @Given("^User sets the baseURI and basePath for GETCardJsonChangesMultiFax request$")
    public void userSetsTheBaseURIAndBasePathForGETCardJsonChangesMultiFaxRequest() throws Exception{
    ...
    public void userSendsTheAPIRequestToGETCardJsonChangesMultiFaxRequest() throws Exception {
    ...
    public void storeThePaymentReferenceNumberAndDisplayOnConsoleForGetCardJsonChangesMultiFaxRequest() {
        ...
        System.out.println("paymentReferenceNumber for GETCardJsonChangesMultiFax Request :- " + paymentReferenceNumber);
    }
}
