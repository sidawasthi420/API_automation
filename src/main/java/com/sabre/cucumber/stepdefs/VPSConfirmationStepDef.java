...
public class VPSConfirmationStepDef {
    ...
    public VPSConfirmationStepDef(TestContext testContext){
    ...
    @Given("^User sets the baseURI and basePath for Confirmation request$")
    public void userSetsTheBaseURIAndBasePathForConfirmationRequest() throws Exception{
    ...
    public void userSendsTheAPIRequestToConfirmationRequest() throws Exception {
    ...
    public void storeThePaymentReferenceNumberAndDisplayOnConsoleForConfirmationRequest() {
        ...
        System.out.println("paymentReferenceNumber for Confirmation Request :- " + paymentReferenceNumber);
    }
}
