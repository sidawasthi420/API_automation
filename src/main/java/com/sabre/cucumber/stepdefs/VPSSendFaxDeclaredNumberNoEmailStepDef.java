...
public class VPSSendFaxDeclaredNumberNoEmailStepDef {
    ...
    public VPSSendFaxDeclaredNumberNoEmailStepDef(TestContext testContext){
    ...
    @Given("^User sets the baseURI and basePath for SendFaxDeclaredNumberNoEmail request$")
    public void userSetsTheBaseURIAndBasePathForSendFaxDeclaredNumberNoEmailRequest() throws Exception{
    ...
    public void userSendsTheAPIRequestToSendFaxDeclaredNumberNoEmailRequest() throws Exception {
    ...
    public void storeThePaymentReferenceNumberAndDisplayOnConsoleForSendFaxDeclaredNumberNoEmailRequest() {
        ...
        System.out.println("paymentReferenceNumber for SendFaxDeclaredNumberNoEmail Request :- " + paymentReferenceNumber);
    }
}