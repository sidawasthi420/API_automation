...
public class VPSGetCard2PhoneNumbersStepDef {
   ...
   // private static String bodyParameter;
    ...
    public VPSGetCard2PhoneNumbersStepDef(TestContext testContext){
    ...
    public void userSetsTheBaseURIAndBasePathForGETCard2PhoneNumberRequest() throws Exception{
    ...
    public void userSendsTheAPIRequestToGETCard2PhoneNumberRequest() throws Exception {
    ...
    public void storeThePaymentReferenceNumberAndDisplayOnConsoleForGetCard2PhoneNumberRequest() {
        ...
        System.out.println("paymentReferenceNumber for GETCard2phoneNumbers Request :- " + paymentReferenceNumber);
    }
}
