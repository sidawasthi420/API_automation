...
public class VPSSendFaxDeclaredNumberNoEmailOrPhoneStepDef {
    ...
    public VPSSendFaxDeclaredNumberNoEmailOrPhoneStepDef(TestContext testContext){
    ...
    @Given("^User sets the baseURI and basePath for SendFaxDeclaredNumberNoEmailOrPhone request$")
    public void userSetsTheBaseURIAndBasePathForSendFaxDeclaredNumberNoEmailOrPhoneRequest() throws Exception{
    ...
    public void userSendsTheAPIRequestToSendFaxDeclaredNumberNoEmailOrPhoneRequest() throws Exception {
    ...
    public void storeThePaymentReferenceNumberAndDisplayOnConsoleForSendFaxDeclaredNumberNoEmailOrPhoneRequest() {
        ...
        System.out.println("paymentReferenceNumber for SendFaxDeclaredNumberNoEmailOrPhone Request :- " + paymentReferenceNumber);
    }
}