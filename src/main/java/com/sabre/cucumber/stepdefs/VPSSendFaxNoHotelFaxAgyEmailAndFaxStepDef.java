...
public class VPSSendFaxNoHotelFaxAgyEmailAndFaxStepDef {
    ...
    public VPSSendFaxNoHotelFaxAgyEmailAndFaxStepDef(TestContext testContext){
    ...
    @Given("^User sets the baseURI and basePath for SendFaxNoHotelFaxAgyEmailAndFax request$")
    public void userSetsTheBaseURIAndBasePathForSendFaxNoHotelFaxAgyEmailAndFaxRequest() throws Exception{
    ...
    public void userSendsTheAPIRequestToSendFaxNoHotelFaxAgyEmailAndFaxRequest() throws Exception {
    ...
    public void storeThePaymentReferenceNumberAndDisplayOnConsoleForSendFaxNoHotelFaxAgyEmailAndFaxRequest() {
        ...
        System.out.println("paymentReferenceNumber for SendFaxNoHotelFaxAgyEmailAndFax Request :- " + paymentReferenceNumber);
    }
}