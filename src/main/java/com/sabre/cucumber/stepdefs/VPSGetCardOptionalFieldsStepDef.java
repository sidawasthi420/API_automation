...
public class VPSGetCardOptionalFieldsStepDef {
    ...
    public VPSGetCardOptionalFieldsStepDef(TestContext testContext){
    ...
    @Given("^User sets the baseURI and basePath for GETCard Optional Fields request$")
    public void userSetsTheBaseURIAndBasePathForGETCardOptionalFieldsRequest() throws Exception{
    ...
    public void userSendsTheAPIRequestToGETCardOptionalFieldsRequest() throws Exception {
    ...
    public void storeThePaymentReferenceNumberAndDisplayOnConsoleForGetCardOptionalFieldsRequest() {
        ...
        System.out.println("paymentReferenceNumber for GETCard Optional Fields Request :- " + paymentReferenceNumber);
    }
}
