...
public class VPSSendFaxDeclaredNumberNeitherHotelEmail_ContactPhone {
    ...
    public VPSSendFaxDeclaredNumberNeitherHotelEmail_ContactPhone(TestContext testContext){
    ...
    @Given("^User sets the baseURI and basePath for SendFaxDeclaredNumberNeitherHotelEmail_ContactPhone request$")
    public void userSetsTheBaseURIAndBasePathForSendFaxDeclaredNumberNeitherHotelEmail_ContactPhoneRequest() throws Exception{
    ...
    public void userSendsTheAPIRequestToSendFaxDeclaredNumberNeitherHotelEmail_ContactPhoneRequest() throws Exception {
    ...
    public void storeThePaymentReferenceNumberAndDisplayOnConsoleForSendFaxDeclaredNumberNeitherHotelEmail_ContactPhoneRequest() {
        ...
        System.out.println("paymentReferenceNumber for SendFaxDeclaredNumberNeitherHotelEmail_ContactPhone Request :- " + paymentReferenceNumber);
    }
}