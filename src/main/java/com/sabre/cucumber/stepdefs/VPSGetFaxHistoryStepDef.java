...
public class VPSGetFaxHistoryStepDef {
    ...
    public VPSGetFaxHistoryStepDef(TestContext testContext){
    ...
    @Given("^User sets the baseURI and basePath for GetFaxHistory request$")
    public void userSetsTheBaseURIAndBasePathForGetFaxHistoryRequest() throws Exception{
    ...
    public void userSendsTheAPIRequestToGetFaxHistoryRequest() throws Exception {
    ...
    public void storeThePaymentReferenceNumberAndDisplayOnConsoleForGetFaxHistoryRequest() {
        ...
        System.out.println("paymentReferenceNumber for GetFaxHistory Request :- " + paymentReferenceNumber);
    }
}
