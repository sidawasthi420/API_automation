...
public class VPSGetCardJsonStepDef {
    ...
    public VPSGetCardJsonStepDef(TestContext testContext){
    ...
    @Given("^User sets the baseURI and basePath for GETCardJson request$")
    public void userSetsTheBaseURIAndBasePathForGETCardJsonRequest() throws Exception{
    ...
    public void userSendsTheAPIRequestToGETCardJsonRequest() throws Exception {
    ...
    public void storeThePaymentReferenceNumberAndDisplayOnConsoleForGetCardJsonRequest() {
        ...
        System.out.println("paymentReferenceNumber for GETCardJson Request :- " + paymentReferenceNumber);
    }
}
